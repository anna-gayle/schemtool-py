...
class UserGuideDialog(tk.Toplevel):
    ...
    def __init__(self, parent):
        ...
        text = (
            ...
            "Tool Buttons:\n"
            "- Move Tool: Click and drag to move components on the canvas.\n"
            "- Grid Tool: Toggle grid lines on/off for better alignment.\n"
            "- Rotate Tool: Rotate selected components by clicking on them.\n"
            "- Delete Tool: Click on a component to delete it.\n\n"
